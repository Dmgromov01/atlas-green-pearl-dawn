...
test.skip("SKILL.md and AGENTS.md name the marker path and bound this script uses", () => {
...
test.skip("the sections that own the brand-task prohibition never affirm a wait", () => {
...
test.skip("SKILL.md tells the pass to self-check with the flag this CLI accepts", () => {
