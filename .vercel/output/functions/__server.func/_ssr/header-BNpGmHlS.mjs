...
import { _ as useSettings, l as cn, p as haptic, s as Button } from "./router-BGvdNc_L.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/header-BNpGmHlS.js
		...
		children: tabs.map((tab) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
					...
					className: cn("max-w-full truncate text-xs font-medium", active ? "text-accent" : "text-muted-foreground"),
...
function Header({ title, subtitle, backTo, right }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-20 flex min-h-[58px] items-center justify-between gap-2 bg-background px-4 pt-[env(safe-area-inset-top)]",
		children: [
