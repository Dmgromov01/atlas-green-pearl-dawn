...
import { _ as useSettings, d as formatEventTime, f as formatTime, h as localDateKey, i as getWeather, l as cn, n as Input, p as haptic, s as Button, u as formatDayLabel } from "./router-BGvdNc_L.mjs";
import { t as useCalendar } from "./calendar-BAvgwltn.mjs";
import { a as nextHourValue, i as holidaysInRange, n as TimeField, r as combineLocal } from "./datetime-6-f-tiPd.mjs";
import { t as Card } from "./card-cl1QDONd.mjs";
import { n as ServiceRow, t as IconWell } from "./service-row-3Ocy_7v9.mjs";
import { t as Skeleton } from "./skeleton-CIcQKVlT.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CHeYihAA.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "text-xs font-bold opacity-85 drop-shadow",
						children: [
							"Ветер ",
							w.wind,
							" м/с"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "weather-card__rule relative z-10 mx-4 mt-2" }),
...
function CalendarCard() {
	...
	const visible = (0, import_react.useMemo)(() => {
		...
		return list.map((d) => {
			...
			const dayEvents = all.filter((e) => localDateKey(e.start) === key).sort((a, b) => a.start.localeCompare(b.start));
			return {
				date: d,
				key,
