...
import { t as useTasks } from "./tasks-CnRVShw1.mjs";
import { n as HUB_MODULES, r as Header, t as AppShell } from "./header-BNpGmHlS.mjs";
import { t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { _ as useSettings, a as searchCities, c as MOSCOW, l as cn, m as hashPin, n as Input, o as lockSession, p as haptic, s as Button } from "./router-BGvdNc_L.mjs";
import { t as useCalendar } from "./calendar-BAvgwltn.mjs";
import { t as Card } from "./card-cl1QDONd.mjs";
import { t as useSources } from "./sources-BeOSQcHN.mjs";
import { t as useDictionary } from "./dictionary-B-oN6zxD.mjs";
import { n as SwitchThumb, t as Switch$1 } from "../_libs/@radix-ui/react-switch+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-DURmmvhk.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						className: "w-full rounded-xl bg-muted px-3 py-2.5 text-left text-sm",
						onClick: () => {
							s.setCity(MOSCOW);
							setQ(MOSCOW.name);
						},
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Локальный PIN на этом устройстве. Не уходит на сервер. Хранится как PBKDF2-хеш."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						type: "password",
						inputMode: "numeric",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm leading-relaxed text-muted-foreground",
						children: "Задачи, словарь, источники и календарь живут в браузере. Подключить Telegram-вход или Google Calendar можно позже — слоты уже заложены в архитектуре."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						variant: "outline",
						className: "w-full text-destructive",
						onClick: wipe,
						children: "Сбросить локальные данные"
					})
				]
			})
		]
