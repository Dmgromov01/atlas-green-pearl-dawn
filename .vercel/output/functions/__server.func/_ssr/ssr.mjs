...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BYQeSVyW.mjs");
...
var manifest = {
	"35006b52e079b8125e37a1269f6c8d91fe778baa53cddafdb6069593d25f4963": {
		functionName: "getQuiz_createServerFn_handler",
		importer: () => import("./quiz-yf-Yh63-.mjs")
	},
	"7cf7d5e69bcb3ccff5d1b5139f463568a2ca48ece792ed1d28515bda49861864": {
		functionName: "getWeather_createServerFn_handler",
		importer: () => import("./weather-D8uhSRxP.mjs")
	},
	"828bedc192e156c67e34471d374a4df5027fff3e4f3d0156db94b97d15318830": {
		functionName: "searchCities_createServerFn_handler",
		importer: () => import("./weather-D8uhSRxP.mjs")
	},
	"8795c6ca53661950be33beb49cb11eb7ea47c2ff3d44100155972ea4cf15c2a6": {
		functionName: "summarizeDigest_createServerFn_handler",
		importer: () => import("./ai-B51BBK9v.mjs")
	},
	"942cd3f894f0e29d46c32574b074909ec7cb4fdd9481542258cc4ea51fb3daca": {
		functionName: "translateText_createServerFn_handler",
		importer: () => import("./translate-DlL0HOMF.mjs")
	},
	"a3352d9583c6f4fcf11a8b767e95c78c387c8eb0b496e295cf9b4cd8a54f5793": {
		functionName: "getActivity_createServerFn_handler",
		importer: () => import("./activity-BFFTe4xu.mjs")
	},
	"bf54b31396212cca2300d4310fc752265d3eaaf9c42f3d6e1c78506490e2e2bf": {
		functionName: "getRates_createServerFn_handler",
		importer: () => import("./rates-COVhVMVe.mjs")
	},
	"e5e829d5b7467a7dc6a78e3aa48d8a3faa53e7dee6708408ecbea27398aa55d3": {
		functionName: "getDigest_createServerFn_handler",
		importer: () => import("./digest-4ydc6s49.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BGvdNc_L.mjs").then((n) => n.t),
