...
//#region node_modules/.nitro/vite/services/ssr/assets/haptic-3Vijz6Vr.js
...
function localDateKey(input) {
	if (typeof input === "string") {
		if (input.length <= 19 && !/[zZ]|[+-]\d{2}:?\d{2}$/.test(input) && /^\d{4}-\d{2}-\d{2}/.test(input)) return input.slice(0, 10);
	}
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-[transform,background-color,opacity,box-shadow] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 disabled:pointer-events-none disabled:opacity-40 enabled:active:scale-[0.96] [&_svg]:size-4 [&_svg]:shrink-0", {
	variants: {
		variant: {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BGvdNc_L.js
...
var styles_default = "/assets/styles-B8GB1ggF.css";
var APP_NAME = "R2D2";
...
//#endregion
export { useSettings as _, searchCities as a, MOSCOW as c, formatEventTime as d, formatTime as f, uid as g, localDateKey as h, getWeather as i, cn as l, hashPin as m, Input as n, lockSession as o, haptic as p, Textarea as r, Button as s, router_exports as t, formatDayLabel as u };
